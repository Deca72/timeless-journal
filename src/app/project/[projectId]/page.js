...
<div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-4 max-w-7xl mx-auto p-2">
    ...
    <button 
      ...
      className="px-4 py-2 bg-black rounded-md text-sm hover:bg-yellow-600 transition"
    >
      Edit Settings
    </button>
    ...
    <input
      ...
      className="p-2 border border-gray-500 rounded w-40 bg-gray-800 text-white"
    />
