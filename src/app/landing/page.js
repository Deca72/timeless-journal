...
export default function LandingPage() {
  ...
  return (
    <>
      <SEO
        title="Timeless Journal – Capture Your Life in Style"
        description="Timeless Journal lets you upload your photos and generate beautiful, AI-powered captions enriched with history, style, and emotion. Create printable postcards, calendars, and more!"
        image="https://mytimelessjournal.com/preview.jpg"
        url="https://mytimelessjournal.com"
      />
      ...
      </div> {/* closes outermost white background Div */}
    </>
  );
}
